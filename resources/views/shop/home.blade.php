...
<div class="top-notification-bar text-center">
            <div class="container">
                <div class="notification-entry">
                    <p>Code: SALE10 10% off all orders. <a href="http://localhost/kidolshop/store">Buy Now!</a></p>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <p>Discount codes available in store:</p>
                    <ul>
                        <li> SALE100K: 100K discount on total order value. </li>
                        <li> SALE10: 10% off total order value. </li>
                    </ul>
                    <div class="about-btn">
                        <a href="{{URL::to('/store')}}" class="btn btn-primary btn-round">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
