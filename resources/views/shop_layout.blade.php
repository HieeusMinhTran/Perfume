...
<head>
    ...
    <title>Perfume Atelier</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- <meta name="csrf-token" content="{{ csrf_token() }}"> -->
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/kidolshop/images/favicon.ico')}}"
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li class="product-cart">
                                                ...
                                                <div class="single-cart-box">
                                                    ...
                                                    </div> <a class="del-icon delete-pd-cart" data-id="{{$cart->idCart}}" data-token="{{csrf_token()}}"><i class="fa fa-trash"
                                                   ></i></a>
                                                </div>
                                                @endforeach
                                            </li>
                            ...
                            <div class="header-account">
                                ...
                                <div class="header-account-list dropdown mini-cart">
                                    ...
                                    <ul class="dropdown-menu ">
                                        ...
                                        <li class="product-btn">
                                            <a href="{{URL::to('/cart')}}" class="btn btn-dark btn-block">View Cart</a>
                                        </li>
                                    </ul>
                                    @else
                                    <a href="#" role="button" data-toggle="dropdown">
            ...
            <div class="site-main-nav">
                <nav class="site-nav">
                    <ul class="navbar-mobile-wrapper">
                        ...
                        <li>
                            <a href="#">Sản phẩm <span class="new">New</span></a>

                            <ul class="mega-sub-menu">
                                <li class="mega-dropdown">
                                    <a class="mega-title" href="#">Menu</a>
